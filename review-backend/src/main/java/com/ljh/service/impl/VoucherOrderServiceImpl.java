...
import com.ljh.Rabbitma.MqSender;
...
//    }
    ...
    public Result seckillVoucher(Long voucherId) {
       ...
       //Long userId = UserHolder.getUser().getId();
        ...
        long id = Long.parseLong(testUserId);
        MqSeckill mqSeckill = new MqSeckill();
        mqSeckill.setUserId(id);
        mqSeckill.setVoucherId(voucherId);
        mqSeckill.setId(orderId2);



        mqSender.sendSeckillMessage(JSON.toJSONString(mqSeckill));
    ...
    //redisson锁  正常串行执行
    @Override
    public Result seckillVoucherTest(Long voucherId) {
